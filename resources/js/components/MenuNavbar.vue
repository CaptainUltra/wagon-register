<template>
  <nav
    class="navbar navbar-expand-md navbar-light bg-white shadow-sm collapse d-md-none"
    id="navbarResponsive"
  >
    <div class="mt-2">
      <p class="font-weight-bold">Табло за управление</p>
          ...
          <div class="collapse" id="wagonCollapse">
            <div class="card card-body mr-3">
              <li class="nav-item">
                ...
                >Регистриране на вагон</router-link>
              </li>
              <li class="nav-item">
                <router-link
                  to="/wagons"
      ...
      <ul class="navbar-nav ml-auto" v-if="userHasRole('moderator-role')">
